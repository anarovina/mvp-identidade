                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        style={{ color: 'black' }}
                                        className="w-full px-4 py-3 rounded-lg bg-white border border-brand-gray/20 text-gray-900 placeholder-gray-500 focus:outline-none focus:border-brand-silver focus:ring-1 focus:ring-brand-silver transition-colors"
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea
                                    ...
                                    onChange={handleChange}
                                    style={{ color: 'black' }}
                                    className="w-full px-4 py-3 rounded-lg bg-white border border-brand-gray/20 text-gray-900 focus:outline-none focus:border-brand-silver focus:ring-1 focus:ring-brand-silver transition-colors resize-none"
